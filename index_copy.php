...
<head>
    ...
    <script>
        $(function(){
            $("#header").load("/volleyball/common/header.html");
        ...
        <main class="main" id="main" onmouseover="menuOut()">
            ...
            <section class="player_background">
                ...
                <ul class="player_list" id="left_players">
                    ...
                    <li onclick="choosePlayer('ply_desc_lee7',this)">이시몬</li>
                    <li onclick="choosePlayer('ply_desc_kang9',this)">강우석</li>
                    <li class="sixth_player" onclick="choosePlayer('ply_desc_ta4',this)">타이스</li>
                </ul>

                <div class="ply_desc" id="ply_desc_seo1">
                    <dl>
                        <dt><?php $arr['p_name'];?></dt>
                        <dd><?php $arr['position'];?></dd>
                        <dd>1989년 7월 21일</dd>
                        <dd><?php $arr['height']." / ".$arr['weight'];?></dd>
                        <dd><?php $arr['reg'];?></dd>
                        <dd><?php $arr['school4'];?></dd>
                        <dd><img src="" alt=""></dd>
                    </dl>
                </div>
